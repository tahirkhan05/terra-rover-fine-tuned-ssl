...
class ImageProcessor:
    ...
    def _add_ui_elements(self, frame):
        ...
        help_text = "Press 's' to ask a question | 'q' to quit"
        cv2.putText(ui_frame, help_text, 
                  (10, h - 15), 
                  self.ui_font, self.ui_scale, self.ui_color, self.ui_thickness)
        
        # Add "Terra Rover" title to the top-left corner
        cv2.putText(ui_frame, "Terra Rover", 
                  (10, 30), 
